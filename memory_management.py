...
def should_use_fp16(device=None, model_params=None, prioritize_performance=True, manual_cast=False): return False


def should_use_bf16(device=None, model_params=None, prioritize_performance=True, manual_cast=False): return False
